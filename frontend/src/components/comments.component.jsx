...
const CommentsContainer = () => {
  ...
  return (
    <div
      className={
        "no-scrollbar max-sm:w-full max-sm:right-0 sm:top-0 fixed " +
        (commentsWrapperVisible
          ? "top-0 sm:right-0"
          : "top-[100%] sm:right-[-100%]") +
        " duration-700 w-[30%] min-w-[350px] h-full z-50 bg-white shadow-2xl py-8 px-16 overflow-y-auto overflow-x-hidden"
      }
    >
      ...
      <hr className="border-grey my-8 w-[120%] -ml-8" />
      ...
      {total_parent_comments > totalParentCommentsLoaded ? (
        <button
          className="text-dark-grey py-2 px-4 hover:bg-grey/50 rounded-md flex items-center"
